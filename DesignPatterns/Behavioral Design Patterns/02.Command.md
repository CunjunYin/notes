# Command
Command Design pattern encapsulate request into objects. So we can parameterize clients with different requests. This decoupled classes that invoke operations from classes that perform these operations.
